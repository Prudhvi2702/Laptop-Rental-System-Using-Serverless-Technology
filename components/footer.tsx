          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-sm text-muted-foreground">kl university vijayawada</span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-primary" />
                <span className="text-sm text-muted-foreground">6302883957</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-primary" />
                <span className="text-sm text-muted-foreground">support@laptoprent.com</span>
              </li>
            </ul>
          </div>
        </div>
