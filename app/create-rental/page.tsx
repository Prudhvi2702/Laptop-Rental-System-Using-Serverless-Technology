...
export default function CreateRentalPage() {
  ...
  // Derived numeric value for calculations and validation
  const rentalDaysNumber = typeof rentalDays === "number" ? rentalDays : 0
  ...
  // Handle rental days change, allowing temporary empty value during editing
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate form data
    if (!selectedLaptopId || rentalDaysNumber < 1 || !selectedLaptop) {
      toast({
    ...
    try {
      ...
      const data = await createRental({
        ...
        toast({
          title: "Rental created successfully!",
          description: `You have rented the ${selectedLaptop.brand} ${selectedLaptop.model} for ${rentalDaysNumber} days.`,
        })
  ...
  const handleProcessPayment = () => {
    if (rentalId && selectedLaptop) {
      ...
      toast({
        title: "Error",
        description: "Missing rental information for payment",
        variant: "destructive",
      })
    }
  }
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="mt-2 space-y-1">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{rentalDaysNumber}</span>
                      </div>
                      <div className="flex justify-between border-t pt-1 mt-1">
                        <span className="font-medium">Total:</span>
                        <span className="font-bold">₹{(((selectedLaptop?.price_per_day || 0)) * rentalDaysNumber).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                    ...
                    {selectedLaptop && (
                      <div className="rounded-lg border p-4 mt-4">
                        ...
                        <div className="mt-2 space-y-1">
                          ...
                          <div className="flex justify-between border-t pt-1 mt-1">
                            <span className="font-medium">Total:</span>
                            <span className="font-bold">₹{(selectedLaptop.price_per_day * rentalDaysNumber).toFixed(2)}</span>
                          </div>
                        </div>
                      </div>
                    )}
